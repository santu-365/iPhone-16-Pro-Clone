  ...
  return (
    <>
      <section className="w-full h-screen relative">
        ...
        <div className="bg-gray-300 text-white py-3 px-4 text-center w-full relative z-20">
        ...
        <div className="relative h-full w-full flex-center flex-col z-10">
          ...
          >
            <a
              href="#highlights"
              className="btn bg-white text-black buy-btn rounded-full px-6 py-2 text-md font-medium mb-4"
            >
              Buy
            </a>
